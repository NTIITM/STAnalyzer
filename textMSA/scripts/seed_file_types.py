...
DEFAULT_FILE_TYPES: List[Dict[str, object]] = [
    ...
    {
        "file_type_id": "aligned_spatial_rna_seq_data",
        "name": "aligned_spatial_rna_seq_data",
        "display_name": "Aligned spatial transcriptomics data",
        "description": "AnnData object (h5ad format) containing spatial transcriptomics data after cross-slice or cross-sample alignment. Preserves expression matrices and spatial coordinates while adding aligned coordinate embeddings, transformation metadata, or registration scores generated by alignment methods such as PASTE.",
        "category": "spatial_transcriptomics",
        "extensions": [".h5ad"],
        "meta": {"obsm_required": ["spatial"]},
    },
    ...
    },
    {
        ...
        "description": "Plain-text file used as a fallback for logs, notes, intermediate summaries, or service-specific textual outputs that do not require the stricter semantics of a formal report.",
        "category": "document",
        "extensions": [".txt", ".log"],
    },
    {
