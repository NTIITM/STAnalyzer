...
\author{
Hanwen Luo\,$^{1,2,\dagger}$,
Liliang Liu\,$^{3,\dagger}$,
Zhongyu Xing\,$^{1,2}$,
Xinlu Li\,$^{1}$,
Xuerui Zhang\,$^{1}$,
Wei Du\,$^{1,2}$,
Bin Liu\,$^{4,*}$, 
Jun Wang\,$^{2,*}$, 
Guoxian Yu\,$^{1,2}$\footnote{To whom correspondence should be addressed. Email: guoxian85@gmail.com. \newline Correspondence may also be addressed to Jun Wang and Bin Liu. Email: kingjun@sdu.edu.cn and gordon0221@163.com. \newline $^\dagger$These authors contributed equally to this work.}%
}


\address{%
$^{1}$School of Software, Shandong University, Jinan 250101, Shandong, China\\
$^{2}$SDU-NTU Centre for Artificial Intelligence Research, Shandong University, Jinan 250101, Shandong, China\\
$^{3}$Interdisciplinary Center, Shandong University, Jinan 250100, Shandong, China\\
$^{4}$Department of Interventional Medicine and Minimally Invasive Oncology, Shandong University, Jinan 250033, Shandong, China}
